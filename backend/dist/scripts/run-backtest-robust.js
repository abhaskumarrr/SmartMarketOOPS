...
exports.RobustBacktestRunner = void 0;
...
class RobustBacktestRunner {
    ...
    async runBacktest() {
        ...
        try {
            logger_1.logger.info('🚀 Starting robust backtesting simulation...');
            ...
            logger_1.logger.info('🎉 Robust backtesting simulation completed successfully!');
        }
        catch (error) {
    ...
    displaySummary(result, startTime) {
        ...
        logger_1.logger.info(`   ✅ Market Data: ${result.dataPoints} points processed`);
        logger_1.logger.info(`   ✅ Trading Engine: ${performance.totalTrades} trades executed`);
...
exports.RobustBacktestRunner = RobustBacktestRunner;
...
//# sourceMappingURL=run-backtest-robust.js.map