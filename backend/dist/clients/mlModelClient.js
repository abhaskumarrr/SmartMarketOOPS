...
exports.MLModelClient = void 0;
const axios_1 = __importDefault(require("axios"));
const logger_1 = require("../utils/logger");
// Create logger
const logger = (0, logger_1.createLogger)('MLModelClient');
/**
...
class MLModelClient {
     ...
     */
    async getEnhancedPrediction(request) {
        try {
            logger.info(`Requesting enhanced prediction for ${request.symbol}`);
            const response = await this.client.post('/enhanced/predict', request);
            return response.data;
        }
        catch (error) {
            const logData = {
     ...
     * @returns Load result
     */
    async loadModel(symbol, modelVersion) {
        try {
     ...
     */
    async loadEnhancedModel(symbol, modelVersion) {
        try {
     ...
     */
    async getEnhancedModelStatus(symbol) {
        try {
     ...
     */
    async updateModelPerformance(symbol, prediction, actualOutcome, confidence) {
        try {
...
exports.MLModelClient = MLModelClient;
...
//# sourceMappingURL=mlModelClient.js.map