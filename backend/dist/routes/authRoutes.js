...
router.post('/register', auth_1.authRateLimiter, authController_1.register);
// Login user - apply rate limiting to prevent brute force attacks
router.post('/login', auth_1.authRateLimiter, authController_1.login);
...
router.post('/forgot-password', auth_1.authRateLimiter, authController_1.forgotPassword);
// Reset password with token - apply rate limiting
router.post('/reset-password', auth_1.authRateLimiter, authController_1.resetPassword);
// OAuth login/signup
router.post('/oauth', authController_1.oauthLogin);
